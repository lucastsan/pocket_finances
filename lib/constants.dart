...
TextStyle kTitleStyle = GoogleFonts.palanquinDark(
  fontSize: 30.0,
  color: Colors.white,
...
TextStyle kCardTitleStyle = GoogleFonts.nunito(
  fontSize: 15.0,
  color: Colors.white,
  fontWeight: FontWeight.bold,
);

TextStyle kBalanceTitleStyle = GoogleFonts.nunito(
  fontSize: 18.0,
  color: Colors.white,
  fontWeight: FontWeight.w800,
);

TextStyle kBalancePopupStyle = GoogleFonts.palanquinDark(
  fontSize: 20.0,
  color: Colors.white,
  fontWeight: FontWeight.w400,
);

TextStyle kBalanceValueStyle = GoogleFonts.palanquinDark(
  fontSize: 20.0,
  color: Colors.white,
  fontWeight: FontWeight.w400,
);
...
TextStyle kHintText = GoogleFonts.nunito(
    color: Color(0xFF6D768A), fontWeight: FontWeight.bold, fontSize: 16.0);
TextStyle kActivatedText = GoogleFonts.nunito(
    color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18.0);
TextStyle kInputText = GoogleFonts.nunito(
